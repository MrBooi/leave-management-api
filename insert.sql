...
INSERT INTO user_leave_allowed (user_id,leave_type_id,leave_amount) VALUES (1,1,3);
INSERT INTO user_leave_allowed (user_id,leave_type_id,leave_amount) VALUES (1,2,8);
INSERT INTO user_leave_allowed (user_id,leave_type_id,leave_amount) VALUES (1,3,10);
INSERT INTO user_leave_allowed (user_id,leave_type_id,leave_amount) VALUES (1,4,3);

     
INSERT INTO leave_request (leave_type_id,user_id,leave_description,start_date,end_date,status_id)
 VALUES (1,1,'sick','2018-10-04','2018-10-06',1);